...
export default [
{
  id:"b67", cat:"behavior", name:"גלולה תחתונה שנפתחת לתפריט", tech:"CSS clip-path · JS", status:"מאושר-עין",
...
{
  id:"b69", cat:"behavior", name:"ערימת כרטיסים להחלקה", tech:"GSAP · pointer events", status:"מאושר-עין",
