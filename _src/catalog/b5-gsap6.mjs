...
.hz-scrub{width:120px;height:120px;flex:0 0 auto;border-radius:26px;background:linear-gradient(140deg,#c6ff4a,var(--accent));display:grid;place-items:center;font-size:34px;color:#0f1020}
